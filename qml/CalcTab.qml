...
Item {
    ...
    ColumnLayout {
        ...
        Item {
            ...
            Layout.preferredHeight: visible ? histCol.implicitHeight : 0
            clip: true
            Behavior on Layout.preferredHeight { NumberAnimation { duration: Theme.normal } }
        ...
        Flickable {
            Layout.fillWidth: true
            Layout.preferredHeight: root.showAssign ? Math.round(40 * Theme.scale) : 0
        ...
        Flickable {
            Layout.fillWidth: true
            Layout.preferredHeight: root.sciOpen ? Math.round(40 * Theme.scale) : 0
            visible: Layout.preferredHeight > 0
            clip: true
