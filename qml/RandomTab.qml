        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Text { text: "🎲 DICE ROLLER"; font.pixelSize: 9; color: Theme.text3; font.letterSpacing: 1 }
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: diceCount+"d"+diceType
                                font.pixelSize: 9; color: Theme.accent2; font.family: Theme.fontMono }
                        }
                    }
                    ...
                    RowLayout {
                        Text { text: "Count:"; font.pixelSize: 11; color: Theme.text2 }
                        Row { spacing: 5
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                Text { anchors.centerIn: parent; text: modelData
                                    color: Theme.text; font.pixelSize: 18; font.weight: Font.Light }
                            }
                        }
                    }
                    Text {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Text { text: "🪙 COIN"; font.pixelSize: 9; color: Theme.text3; font.letterSpacing: 1 }
                        Item { Layout.fillWidth: true }
                        Row {
                            spacing: 8
                    ...
                    Rectangle {
                        ...
                        Text { anchors.centerIn: parent; text: coinFlipping ? "…" : "Flip Coin"
                            color: Theme.accent2; font.pixelSize: 13; font.weight: Font.DemiBold }
                        MouseArea { anchors.fill: parent
                            onClicked: {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Text { text: "🎯 RANGE"; font.pixelSize: 9; color: Theme.text3; font.letterSpacing: 1 }

                    RowLayout {
                        spacing: 12
                        Column { spacing: 4; Layout.fillWidth: true
                            Text { text: "Min"; color: Theme.text2; font.pixelSize: 11 }
                            StyledInput { width: parent.width; text: randMin; onTextChanged: randMin = text
                                inputMethodHints: Qt.ImhDigitsOnly }
                        }
                        Column { spacing: 4; Layout.fillWidth: true
                            Text { text: "Max"; color: Theme.text2; font.pixelSize: 11 }
                    ...
                    Text { visible: randResult !== null
                        ...
                        color: Theme.text; font.pixelSize: 40; font.weight: Font.Light
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    // Header row
                    RowLayout {
                        Text { text: "🧮 MATH PRACTICE"; font.pixelSize: 9; color: Theme.text3; font.letterSpacing: 1 }
                        Item { Layout.fillWidth: true }
                        // Reset score
                        Rectangle {
                            ...
                            Text { id: resetLbl; anchors.centerIn: parent; text: "reset"; font.pixelSize: 8; color: "#F43F5E" }
                    ...
                    RowLayout {
                        ...
                        Text {
                            ...
                            font.pixelSize: 11; color: "#8080b8"
                        }
                        Rectangle {
                        ...
                        Rectangle {
                            ...
                            Text { id: streakLbl; anchors.centerIn: parent; text: "🔥 " + streak; font.pixelSize: 9; color: "#f0a060" }
                        }
                    }
                    ...
                    Rectangle {
                        ...
                        Text { id: tagLbl; anchors.centerIn: parent; text: currentTag; font.pixelSize: 9; color: Theme.accent2; font.family: Theme.fontSans }
                    }
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            color: "#F59E0B"; font.pixelSize: 11; font.family: Theme.fontSans
                            wrapMode: Text.WordWrap
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Behavior on color { ColorAnimation { duration: 120 } }
                            Text { anchors.centerIn: parent; text: "hint"; color: "#F59E0B"; font.pixelSize: 11 }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: "skip"; color: Theme.text3; font.pixelSize: 11 }
                            MouseArea { anchors.fill: parent; onClicked: newMathProblem() }
                        }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Text { anchors.centerIn: parent; text: "skip"; color: Theme.text3; font.pixelSize: 9 }
                            MouseArea { anchors.fill: parent; onClicked: newMathProblem() }
                        }
                    }
                }
